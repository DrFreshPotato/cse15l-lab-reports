...
#### ***Sources: <https://ss64.com/bash/grep.html> and [ChatGPT](https://drfreshpotato.github.io/cse15l-lab-reports/lab3/ChatGPTLogs.html) (<-- Prompts used are hyperlinked on this)***
### grep -v
```
//Example 1
